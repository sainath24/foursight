...
public class PotholeComplaint extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pothole_complaint);
...
//        }
        ...
        pic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                complaint.cid = "pothole" + firebaseDatabase.push().getKey();
...
//                new Upload_img().execute("http://192.168.1.8:5000/image",encodedImage,firebaseAuthID,currentDateandTime,latitude+"",longitude+"",numcows+"");
                new Upload_Complaint_pothole().execute(complaint);
